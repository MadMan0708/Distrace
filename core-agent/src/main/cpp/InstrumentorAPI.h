...
namespace Distrace {
    ...
    private:
        ...
        /**
         * Directory where all auxiliary classes are stored. This is temporary directory deleted when the native agent
         * is stopped
         */
        std::string pathToDirWithAuxClasses;
        ...
        /**
         * List of received auxiliary classes, we need to keep this list because
         * auxiliary classes should not be instrumented
         */
        std::set<std::string> auxClassesCache;
        ...
        */
        bool shouldInstrument(std::string className);
        ...
        /**
         * Cache whether this class is in auxiliary classes cache
         */
        bool isInAuxClassCache(std::string className);

        /**
         * Cache auxiliary class names. We need to store auxiliary class names since we don't want these classes to be
         * instrumented.
         */
